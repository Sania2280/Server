...
void server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->toSetComunication((*reinterpret_cast< std::add_pointer_t<server*>>(_a[1]))); break;
        case 1: _t->slotsReadyRead(); break;
        case 2: _t->handleDisconnection(); break;
        case 3: _t->SendIdentificator(); break;
        case 4: _t->ConectionHub(); break;
        case 5: _t->fromSetComunication(); break;
        default: ;
        }
        ...
        {
            using _t = void (server::*)(server * );
            if (_t _q_method = &server::toSetComunication; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void server::toSetComunication(server * _t1)
{
